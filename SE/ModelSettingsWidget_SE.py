...
from ui.DragListWidget import DragListWidget
from ui.DropListWidget import DropListWidget
...
class ModelSettingsWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.resetPushButton.setFixedWidth(100)
        ...
        pushButtonLayout.addWidget(self.savePushButton, 0, Qt.AlignLeft)
        pushButtonLayout.addStretch()
        pushButtonLayout.addWidget(self.resetPushButton, 0, Qt.AlignRight)
        pushButtonLayout.addStretch()
        ...
        layout.addLayout(dragDropLayout)
